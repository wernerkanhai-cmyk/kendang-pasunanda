    ...
    <div className="app-container">
      ...
      <header className="app-header">
        ...
        <div className="header-center">
          ...
          >
            {sampleSet === 'kendang'
              ? <KendangIcon size={42} color={theme === 'classic' ? '#ffffff' : 'var(--accent)'} style={{ filter: theme === 'classic' ? 'drop-shadow(0 0 5px rgba(255,255,255,0.45))' : 'drop-shadow(0 0 5px rgba(var(--accent-rgb),0.6))', transition: 'filter 0.25s' }} />
